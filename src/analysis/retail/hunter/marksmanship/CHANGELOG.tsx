...
export default [
  ...
  from Wailing Arrow and Readiness
  <br/>
  Simplified reset logic inside of <SpellLink spell={TALENTS.LOCK_AND_LOAD_TALENT} />
  <br/>
  Inclusion of Tactical Reload and Steady Focus for CDR logic in Aimed Shot
  <br/>
  ...
  change(date(2024, 11, 10), <>Added <SpellLink spell={TALENTS.BLACK_ARROW_TALENT} /> and <SpellLink spell={SPELLS.FORTITUDE_OF_THE_BEAR} /></>, Yellot),
